...
In configuration 3 (level3.txt), dining contains a key, which can be picked up with input K. The potion in library now requires you to have the key to pick it up. After that, the outcome is identical to configuration 3.
